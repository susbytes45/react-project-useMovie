    ...
    <>
      ...
      <Main>
        ...
        <Box>
          ...
          <MovieWatchedList watched={watched}></MovieWatchedList>
        </Box>
      </Main>
    </>
  );
...
const MoviesList = function ({ movies }) {
  return (
    <ul className="list">
      {movies?.map((movie) => (
        <Movies movie={movie} key={movie.imdbID}></Movies>
      ))}
    </ul>
  );
};
...
const MovieWatchedList = function ({ watched }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
